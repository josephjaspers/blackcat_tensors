...
//
//	~Tensor_Base_impl() {
//		MATHLIB::destroy(static_cast<deriv&>(const_cast<Tensor_Utility&>(*this)).data());
//	}
//};
//
//
...
//	public SHAPE,
//	public Tensor_Utility<scalar_type, DERIVED, MATHLIB, MTF::isPrimitive<scalar_type>::conditional>
//{
//

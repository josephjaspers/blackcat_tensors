...
NN_Core/Deprecated/Copy\ of\ MNIST_alternatetest.o: ../NN_Core/Deprecated/Copy\ of\ MNIST_alternatetest.cu
	...
	/usr/local/cuda-9.1/bin/nvcc -I/home/joseph/BlackCat_Libraries/BlackCat_Tensors3.3 -I/home/joseph/BlackCat_Libraries/BlackCat_Tensors3.2/BlackCat_Tensors_Functions/Functions -G -g -O0 -Xcompiler -fopenmp -gencode arch=compute_52,code=sm_52  -odir "NN_Core/Deprecated" -M -o "$(@:%.o=%.d)" "$<"

...
#ifndef BLACKCAT_NEURAL_NETWORKS_POLYMORPHIC_LAYER_H_
#define LAYER_H_
...
template<
	...
	class ValueType,
	class SystemTag,
	class Allocator=layer_default_allocator<ValueType, SystemTag>,
...
struct Polymorphic_Layer_Base
{
	...
	using next_layer_type = Polymorphic_Layer_Base<
			output_tensor_dimension,
			output_value_type,
			output_system_tag>;

	using this_layer_type = Polymorphic_Layer_Base<

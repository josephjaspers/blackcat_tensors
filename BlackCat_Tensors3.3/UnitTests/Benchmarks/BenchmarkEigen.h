...
//	BC::Scalar<double, BC::CPU> scal(3.0);
//
...
//		eg_a(i) = bc_a.internal().memptr()[i];
//		eg_b(i) = bc_b.internal().memptr()[i];
//		eg_c(i) = bc_c.internal().memptr()[i];
//		eg_d(i) = bc_d.internal().memptr()[i];
//		eg_e(i) = bc_e.internal().memptr()[i];
//	}
//
...
//	std::string winner = time_dif < 0 ? ("Blackcat_Tensors better_by (percent)" + std::to_string(eigen_time / blackcat_time))
//											: ("Eigen better by (percent)" + std::to_string(blackcat_time / eigen_time));
//
...
//	float time_dif = (blackcat_time - eigen_time);
//	std::string winner = time_dif < 0 ? ("Blackcat_Tensors better_by (percent)" + std::to_string(eigen_time / blackcat_time))
//											: ("Eigen better by (perecent)" + std::to_string(blackcat_time / eigen_time));
//
//	std::string info1 = "SIZE = [" + std::to_string(SIZE) + "][" + std::to_string(SIZE) + "]";
//	std::string info2 = " Reps = " + std::to_string(repetitions);
//	std::string bc_time = "BLACKCAT_TENSORS_TIME:  " + std::to_string(blackcat_time);

...
//	__BCinline__ 	   auto& operator ()(int m_, int n_)	   	{ return array_ptr[m_ + n_ * this->cols()]; }
	...
	__BCinline__ const auto outer_shape() const { return l_array([&](int i) { return i == 0 ? left.rows() : (i == 1 ? left.rows() * right.cols() : 1);}); }
...
//	}
	...
	__BCinline__ void eval() const {}
	__BCinline__ void eval(scalar_type* array) const {

...
//
//#ifndef TENSOR_OPERATIONS_SCALAR_H_
//#define TENSOR_OPERATIONS_SCALAR_H_
//
//
//
//
...
//
//namespace BC {
//template<class internal_t, class enabler> class Tensor_Base;
//
//namespace module {
...
//class Tensor_Operations<Tensor_Base<internal_type>, std::enable_if_t<internal_type::DIMS() == 0>> {
//
//	template<class, class> friend class Tensor_Operations;
//
...
//		static_assert(std::is_same<allocator_t_of<derived>, allocator_t_of<deriv>>::value,
...
//
//
//#endif /* TENSOR_OPERATIONS_SCALAR_H_ */

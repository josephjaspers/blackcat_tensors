...
struct CacheEvaluator {
	...
	template<class branch>__BCinline__ //The branch is an array, no evaluation required
	...
	template<class branch>__BCinline__ //Create and return an array_core created from the expression
...
template<class array_t, class expression_t>__BCinline__
...
template<class expression_t>__BCinline__

...
public:
	...
	inline __attribute__((always_inline)) binary_expression_scalar_L(lv l, rv r) : left(l), right(r) {}
	inline __attribute__((always_inline)) auto operator [](int index) const { return oper(left[0], right[index]); }
};
...
public:
	...
	inline __attribute__((always_inline)) binary_expression_scalar_R(lv l, rv r) : left(l), right(r) {}

	inline __attribute__((always_inline)) auto operator [](int index) const { return oper(left[index], right[0]);}
};

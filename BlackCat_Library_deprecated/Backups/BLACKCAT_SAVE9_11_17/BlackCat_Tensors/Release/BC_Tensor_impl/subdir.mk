...
BC_Tensor_impl/%.o: ../BC_Tensor_impl/%.cpp
	...
	/usr/local/cuda-8.0/bin/nvcc -O2 -std=c++11 -gencode arch=compute_37,code=sm_37 -gencode arch=compute_50,code=sm_50 -gencode arch=compute_52,code=sm_52 -gencode arch=compute_53,code=sm_53 -gencode arch=compute_60,code=sm_60  -odir "BC_Tensor_impl" -M -o "$(@:%.o=%.d)" "$<"

...
void Tensor_Operations<number_type>::dot(number_type * s, const number_type * m1, unsigned m1_rows, unsigned m1_cols, const number_type * m2, unsigned m2_cols) {
...
template<>
void Tensor_Operations<float>::dot(float * s, const float * m1, unsigned m1_rows, unsigned m1_cols, const float * m2, unsigned m2_cols) {
...
template<>
void Tensor_Operations<double>::dot(double * s, const double * m1, unsigned m1_rows, unsigned m1_cols, const double * m2, unsigned m2_cols) {
